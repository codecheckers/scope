...
- 91551167: top and 2nd level disagree
- 88008617: "Sciences" should be "sciences"
- 91550549: typo: "asic medicine"
- 88008615: top level is missing
...
p3 <- frasc_top_long %>% 
  ...
  labs(x = NULL, y = "# of studies", fill = NULL)
```
...
88009363: just to check: should this be two studies?


Answers to questions from Tony:

- spike in 2011 is not caused by full counting
- x labels: this is the number of studies looking into these disciplines. hope
this is clear enough from "# of studies"
