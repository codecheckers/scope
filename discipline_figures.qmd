...
88009363: just to check: is this really two studies (counting twice in the 
PRISMA chart)?

Answers:

- we can align labels for panels A and B, but then either get a figure that is 
too tall, or a gap.
- Adding a legend with more colours is possible, but would add quite a bit of 
further text that essentially duplicates what is already in the figure
